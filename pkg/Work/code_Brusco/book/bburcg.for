      ...
      DOUBLE PRECISION TIMEA,TIMEB,TIMTOT,A(50,50),EPS
      REAL S1
      INTEGER X(50),Q(50),D(50,50,50),S(50),DD(50,50,50),UNSEL(50)
C
C #################################################################
C 10/13/01 This program fits an "unweighted" row and column gradient criterion
...
C         Same as CDA1b, but with column gradient considered as well.
...
C      write(*,*) ism,ism2,ism3
 ...
 69   FORMAT(' MAXIMUM UNWEIGHTED ROW AND COLUMN GRADIENT INDEX ',I7)
...
C
      ...
      IMPLICIT INTEGER(A-Z)
      INTEGER Q(50),D(50,50,50),S(50),DD(50,50,50)
      Z1=0
      DO I = 1,M-2
        R1=Q(I)
        DO J = I+1,M-1
