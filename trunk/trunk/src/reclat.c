...
static const char* BMtarget[] = {
  /* BM_NORMAL      0 */  "frequent item sets",
  /* BM_CLOSED      1 */  "closed item sets",
  /* BM_MAXIMAL     2 */  "maximally frequent item sets",
};
...
/* 	char    *cominds = NULL;      /\* comment indicators *\/ */
  ...
  trans  = param.trans = *INTEGER(GET_SLOT(parms, install("trans")));
