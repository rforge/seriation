...
# this method is taken from package gclus Catherine Hurley 
# since the package has no NAMESPACE which made importing
# it difficult. This code is covered by GPL version 2 or later.
